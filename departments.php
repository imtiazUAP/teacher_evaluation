		...
		<div id="templatemo_main">
			...
			<table class="hoverTable" width="900" border="1"
				...
				<tr align="center">
					...
					<td width="50">100</td>
					<td width="150"><a href="teacher_list_cse.php" class="current">Department of Computer Science &
							Engineering</a></td>
					<td width="150">3.1</td>
				</tr>
				<tr align="center">
					<td width="80" height="30"><img src="images/flashmo.jpg" alt="image" /></td>
					<td width="50">101</td>
					<td width="150"><a href="teacher_list_civil.php" class="current">Department of Civil Engineering</a>
					</td>
					<td width="150">3.4</td>
				</tr>
				<tr align="center">
				...
				<tr align="center">
					<td width="80" height="30"><img src="images/flashmo.jpg" alt="image" /></td>
					<td width="50">103</td>
					<td width="150"><a href="teacher_list_eee.php" class="current">Department of Electronics &
