...
<body> 
  ...
  <div id="templatemo_wrapper">
   ...
   <?php include("menu_header.php"); ?> 	
		  ...
		  <td>
		  <input type="text" name="teachers_code">
		  ...
		  <p>Part1: On Instructor Performance( A=Strongly agree; B=Agree; C=Neutral; D=Disagree; E=Strongly disagree )</p>
        <table>
	<tr>
		 <td>
...
<input type="radio" name="question_12" value="1">E
	  ...
	  <textarea name="general_comments_on_instructor" rows="4" cols="80"></textarea>
	   ...
	   <p>Part2: Organization of the Course( A=Strongly agree; B=Agree; C=Neutral; D=Disagree; E=Strongly disagree )</p>
...
<input type="radio" name="question_15" value="1">E
 ...
 <textarea name="general_comments_on_course" rows="4" cols="80"></textarea>
