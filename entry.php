		...
		<div id="templatemo_wrapper">
			...
			<div id="templatemo_main">
				<form action="entry_save.php">
					...
					<p>Part1: On Instructor Performance( A=Strongly agree; B=Agree; C=Neutral; D=Disagree; E=Strongly
						disagree )</p>
					<table>
						<tr>
							<td>
					...
					<br />
					<br />
					<p>Part2: Organization of the Course( A=Strongly agree; B=Agree; C=Neutral; D=Disagree; E=Strongly
						disagree )</p>
					<table>
						<tr>
							<td>
