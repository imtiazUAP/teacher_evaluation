...
$query="SELECT course_id,teachers_name,teachers.teachers_code,teachers.teachers_id FROM teachers INNER JOIN course ON course.teachers_code=teachers.teachers_code WHERE semester_id='$userdata[semester_id]'";
...
$query="SELECT course_id,course_code,course_name FROM course WHERE semester_id='$userdata[semester_id]'";
$rs = mysql_query($query) or die ('Error submitting');
while ($rows = mysql_fetch_assoc($rs)) {
...
?>
		  ...
		  <br />
		  <br />
		  <p style="color:#0886C1">Part1: On Instructor Performance( A=Strongly agree; B=Agree; C=Neutral; D=Disagree; E=Strongly disagree )</p>
        <table>
	<tr>
		 <td>
...
<input type="radio" name="question_4" value="1">E
		...
		<tr>
		 <td>
             <label for="female">5. Instructor was abble to hold attention of the students throughout the class </label>
		 </td>
		 <td style="color:#FF0000">
...
<input type="radio" name="question_5" value="1">E
	...
	<tr>
		 <td>
             <label for="female">6. The exams,quizzes and assignments covered the contents specified in the syllebus </label>
		 </td>
		 <td style="color:#FF0000">
...
<input type="radio" name="question_6" value="1">E
	...
	<tr>
		 <td>
             <label for="female">7. Instructor motivated me to think more critically and stimulated intellectual curiosity </label>
		 </td>
		 <td style="color:#FF0000">
...
<input type="radio" name="question_7" value="1">E
	...
	<tr>
		 <td>
             <label for="female">8. Instructor encouraged participation,discussion and questions from students </label>
		 </td>
		 <td style="color:#FF0000">
...
<input type="radio" name="question_11" value="1">E
	...
	<tr>
		 <td>
             <label for="female">12. The contents specified in the syllabus for the course were actually covered </label>
		 </td>
		 <td style="color:#FF0000">
...
<input type="radio" name="question_12" value="1">E
	  ...
	  <textarea name="general_comments_on_instructor" rows="4" cols="80"></textarea>
	   ...
	   <p style="color:#0886C1">Part2: Organization of the Course( A=Strongly agree; B=Agree; C=Neutral; D=Disagree; E=Strongly disagree )</p>
	   
	   <table>
	<tr>
		 <td>
             <label for="female">13. The course provided an oppotunity to develop relevant learning and competencies </label>
		 </td>
		 <td>
...
<input type="radio" name="question_13" value="1">E
	...
	<tr>
		 <td>
             <label for="female">14. Text books/reading metarials used in the course were appropriate </label>
		 </td>
		 <td>
...
<input type="radio" name="question_14" value="1">E
	...
	<tr>
		 <td>
             <label for="female">15. Total time allocated for the course was appropriate to cover all the contents </label>
		 </td>
		 <td>
