			...
			<body style="background-color:#d7d7d7;margin:auto">
				...
				<div id="wowslider-container1">
					<div class="ws_images">
						<ul>
							...
							<li><a href="http://wowslider.com"><img src="data1/images/1.jpg" alt="joomla slider"
										title="1" id="wows1_1" /></a></li>
					...
					<div class="ws_script" style="position:absolute;left:-99%"><a href="http://wowslider.com/vi">jquery
							slider</a> by WOWSlider.com v8.2</div>
				...
				<table>
					<tr>
						<td>
							...
							<p>Agile model
								...
								(XP) is currently one of the most well known agile development life cycle model.
							</p>
						</td>
						<td>
							<h3>Paragraph_2</h3>
							<div class="image_wrapper fl_img"><img src="images/webdesignmo.jpg" alt="image" /></div>
							<p>Disadvantages of Agile model:
								...
								the development process. Hence it has no place for newbie programmers, unless combined
					...
					<tr>
						<td>
							...
							<p>
								...
								through the requirements, design, implementation and testing phases. A working version
								of software is produced during the first module, so you have working software early on
								during the software life cycle. Each subsequent release of the module adds function to
						...
						<td>
							...
							<p>Advantages of Incremental model:
					...
					<tr>
						...
						<td>
							<h3>Paragraph_6</h3>
							<p>Advantages of Iterative model:
